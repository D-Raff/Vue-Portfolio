  ...
  <div class="mainComp">
    <div class="reactor">
      ...
      <div class="iron-core">
        ...
        <span class="core-ring2"></span>
        <span class="core-tripod1">
          <span class="rod"></span>
          <span class="rod"></span>
          <span class="rod"></span>
        </span>
        <span class="core-tripod2">
          <span class="rod"></span>
          <span class="rod"></span>
          <span class="rod"></span>
        </span>
        <span class="core-tripod3">
          <span class="rod"></span>
          <span class="rod"></span>
          <span class="rod"></span>
        </span>
        <span class="copper-ring"></span>
        <span class="copper-ring2"></span>
      ...
      <div class="inner-core">
        <span class="core-ring"></span>
        <span class="inner-core-tripod1"> </span>
        <span class="inner-core-tripod2"> </span>
        <span class="inner-core-tripod3"> </span>
      </div>
    </div>
  </div>
</template>
...
.iron-core {
  ...
  align-items: center;
  z-index: 3;
  box-shadow: inset 0px 0px 200px #67c7eb;
}
